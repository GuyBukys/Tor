...
namespace Tor.Infrastructure.Migrations
{
    ...
    [Migration("20240430123029_AddedTierConfigurations")]
    partial class AddedTierConfigurations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tor.Domain.AppointmentAggregate.Appointment", b =>
                {
                    ...
                    b.Property<bool>("HasReceivedReminder")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Business", b =>
                {
                    ...
                    b.Property<string>("NotesForAppointment")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<Guid?>("ReferringBusinessId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReferringBusinessId");
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Entities.BlockedClient", b =>
                {
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Entities.ReservedTimeSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ReservedTimeSlots", (string)null);
                });
            ...
            modelBuilder.Entity("Tor.Domain.CategoryAggregate.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("48258ac6-200c-454b-88d1-3ca708b50ed0"),
                        ...
                        new
                        {
                            Id = new Guid("761145fd-46d6-4902-9cd6-7259009a9fd8"),
            ...
            modelBuilder.Entity("Tor.Domain.MessageBlastAggregate.Entities.BusinessMessageBlast", b =>
                {
                    ...
                    b.HasKey("BusinessId", "MessageBlastId");
            ...
            modelBuilder.Entity("Tor.Domain.TierAggregate.Tier", b =>
                {
                    ...
                    b.Property<bool>("AppointmentApprovals")
                        .HasColumnType("boolean");
                    ...
                    b.Property<TimeSpan>("FreeTrialDuration")
                        .HasColumnType("interval");

                    b.Property<short>("MaximumStaffMembers")
                        .HasColumnType("smallint");

                    b.Property<bool>("MessageBlasts")
                        .HasColumnType("boolean");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FreeTrialDuration = new TimeSpan(30, 0, 0, 0, 0),
                            MaximumStaffMembers = (short)1,
                            MessageBlasts = false,
                            Payments = false,
                            Type = (short)1
                        },
                        new
                        {
                            ...
                            FreeTrialDuration = new TimeSpan(0, 0, 0, 0, 0),
                        ...
                        new
                        {
                            Id = new Guid("8c8c5bf9-9fbf-4fc9-8df0-f3505aa8798e"),
                            AppointmentApprovals = true,
                            AppointmentReminders = true,
                            Description = "enterprise tier for payments",
                            ExternalReference = "Enterprise",
                            FreeTrialDuration = new TimeSpan(0, 0, 0, 0, 0),
                            MaximumStaffMembers = (short)10,
                            MessageBlasts = true,
                            Payments = true,
                            Type = (short)2
                        });
            ...
            modelBuilder.Entity("Tor.Domain.WaitingListAggregate.WaitingList", b =>
                {
                    ...
                    b.HasIndex("AtDate", "StaffMemberId")
                        .IsUnique();
                    ...
                    b.OwnsOne("Tor.Domain.AppointmentAggregate.ValueObjects.ClientDetails", "ClientDetails", b1 =>
                        {
                            ...
                            b1.OwnsOne("Tor.Domain.Common.ValueObjects.PhoneNumber", "PhoneNumber", b2 =>
                                {
                                    b2.Property<Guid>("ClientDetailsAppointmentId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("ClientDetailsAppointmentId");

                                    b2.ToTable("Appointments");

                                    b2.WithOwner()
                                        .HasForeignKey("ClientDetailsAppointmentId");
                                });
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Business", b =>
                {
                    b.HasOne("Tor.Domain.BusinessAggregate.Business", "ReferringBusiness")
                        .WithMany()
                        .HasForeignKey("ReferringBusinessId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Tor.Domain.TierAggregate.Tier", "Tier")
                        .WithMany("Businesses")
                    ...
                    b.OwnsOne("Tor.Domain.BusinessAggregate.ValueObjects.BusinessSettings", "Settings", b1 =>
                        {
                            ...
                            b1.Property<int>("AppointmentReminderTimeInHours")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                                .HasDefaultValue(24);
                            ...
                            b1.Property<int>("MaximumAppointmentsForClient")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                                .HasDefaultValue(3);
                    ...
                    b.Navigation("ReferringBusiness");
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Entities.ReservedTimeSlot", b =>
                {
                    b.HasOne("Tor.Domain.BusinessAggregate.Entities.StaffMember", "StaffMember")
                        .WithMany("ReservedTimeSlots")
                        .HasForeignKey("StaffMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Tor.Domain.Common.ValueObjects.TimeRange", "TimeRange", b1 =>
                        {
                            b1.Property<Guid>("ReservedTimeSlotId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ReservedTimeSlotId");

                            b1.ToTable("ReservedTimeSlots");

                            b1.WithOwner()
                                .HasForeignKey("ReservedTimeSlotId");
                        });
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Entities.StaffMember", b =>
                {
                    ...
                    b.OwnsOne("Tor.Domain.BusinessAggregate.ValueObjects.StaffMemberSettings", "Settings", b1 =>
                        {
                            b1.Property<Guid>("StaffMemberId")
                                .HasColumnType("uuid");

                            b1.Property<bool>("SendNotificationsWhenAppointmentCanceled")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true);

                            b1.Property<bool>("SendNotificationsWhenAppointmentScheduled")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Tor.Domain.CategoryAggregate.Category", b =>
                {
                    b.OwnsOne("Tor.Domain.Common.ValueObjects.Image", "Image", b1 =>
                        {
