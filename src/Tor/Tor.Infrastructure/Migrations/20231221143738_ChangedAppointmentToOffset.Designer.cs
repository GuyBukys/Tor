...
namespace Tor.Infrastructure.Migrations
{
    ...
    [Migration("20231221143738_ChangedAppointmentToOffset")]
    partial class ChangedAppointmentToOffset
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tor.Domain.UserAggregate.Entities.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tor.Domain.UserAggregate.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Tor.Domain.AppointmentAggregate.ValueObjects.ClientDetails", "ClientDetails", b1 =>
                        {
                            ...
                            b1.OwnsOne("Tor.Domain.Common.ValueObjects.Address", "Address", b2 =>
                                {
                                    b2.Property<Guid>("ClientDetailsAppointmentId")
                                        .HasColumnType("uuid");

                                    b2.Property<short?>("ApartmentNumber")
                                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Entities.Service", b =>
                {
                    b.HasOne("Tor.Domain.BusinessAggregate.Entities.StaffMember", null)
                        .WithMany("Services")
                        .HasForeignKey("StaffMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tor.Domain.ClientAggregate.Client", b =>
                {
                    b.HasOne("Tor.Domain.UserAggregate.User", null)
                        .WithOne()
            ...
            modelBuilder.Entity("Tor.Domain.UserAggregate.Entities.RefreshToken", b =>
                {
                    b.HasOne("Tor.Domain.UserAggregate.User", null)
                        .WithOne()
                        .HasForeignKey("Tor.Domain.UserAggregate.Entities.RefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
