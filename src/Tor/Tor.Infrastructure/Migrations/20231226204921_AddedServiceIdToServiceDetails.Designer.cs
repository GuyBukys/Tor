...
namespace Tor.Infrastructure.Migrations
{
    ...
    [Migration("20231226204921_AddedServiceIdToServiceDetails")]
    partial class AddedServiceIdToServiceDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tor.Domain.MessageBlastAggregate.MessageBlast", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CanEditBody = true,
                            CanEditTitle = true,
                            Description = "Send to clients two hours after their first visit",
                            IsActive = true,
                            Name = "WelcomeNewClient",
                            TemplateBody = "אנחנו כאן ב *שם עסק* מקווים שנהנית מהביקור! אנחנו שמחים מאוד שקפצת לבקר אצלנו. מקווים לראות אותך שוב בקרוב",
                            TemplateTitle = "תודה שבאת!",
                            Type = (short)1
                        });
                });
