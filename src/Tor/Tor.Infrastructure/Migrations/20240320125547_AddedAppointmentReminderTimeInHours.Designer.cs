...
namespace Tor.Infrastructure.Migrations
{
    ...
    [Migration("20240320125547_AddedAppointmentReminderTimeInHours")]
    partial class AddedAppointmentReminderTimeInHours
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tor.Domain.BusinessAggregate.Business", b =>
                {
                    ...
                    b.OwnsOne("Tor.Domain.BusinessAggregate.ValueObjects.Subscription", "Subscription", b1 =>
                        {
                            b1.Property<Guid>("BusinessId")
                                .HasColumnType("uuid");

                            b1.Property<int>("AllowedStaffMembers")
                                .HasColumnType("integer");

                            b1.Property<TimeSpan>("FreeTrialDuration")
                                .HasColumnType("interval");

                            b1.Property<bool>("IsFreeTrial")
                                .HasColumnType("boolean");
